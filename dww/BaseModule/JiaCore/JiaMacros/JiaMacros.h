...
//  dww
//
//  Created by Shadow.G on 16/12/22.
...
#define kKeyWindow          ((AppDelegate*)[[UIApplication sharedApplication] delegate]).window
...
//字典是否为空
#define kDictIsEmpty(dic) (dic == nil || [dic isKindOfClass:[NSNull class]] || ![dic isKindOfClass:[NSDictionary class]] || [dic count] == 0)
//是否是空对象
...
#define JiaCoreWeakSelf(type)  __weak typeof(type) weak##type = type;
#define JiaCoreStrongSelf(type)  __strong typeof(type) type = weak##type;
