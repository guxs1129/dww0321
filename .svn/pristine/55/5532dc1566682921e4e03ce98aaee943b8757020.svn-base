    ...
    MKNetworkOperation *op = [self loadContent:urlParam params:params method:method onCompletion:^(NSData *responseData)
    {
        @try {
            ...
            else
            {
                ...
                [SWAlertView showAlertWithTitle:@"" message:[NSValueToString([jsonDic objectForKey:@"errorStr"]) length] > 0 ? NSValueToString([jsonDic objectForKey:@"errorStr"]) : @"数据异常" completionBlock:nil cancelButtonTitle:@"确定" otherButtonTitles:nil];
        ...
        @catch (NSException *exception)
        {
            ...
            [SWAlertView showAlertWithTitle:@"" message:errorResult.errorStr completionBlock:nil cancelButtonTitle:@"确定" otherButtonTitles:nil];
