...
//  Zhaowaibao
//
//  Created by Shadow.G on 16/8/10.
...
@interface SWAlertView ()<UIAlertViewDelegate>
...
+ (id)showAlertWithTitle:(NSString *)title message:(NSString *)message
         completionBlock:(void (^)(NSUInteger buttonIndex, SWAlertView *alertView))block
       ...
       otherButtonTitles:(NSString *)otherButtonTitles, ...
{
    ...
    SWAlertView *alertView = [[self alloc] initWithTitle:title
                                                 message:message
